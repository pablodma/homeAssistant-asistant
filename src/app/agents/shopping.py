...
from .tools.shopping_executor import execute_shopping_tool, format_shopping_response
        ...
        try:
            if self.provider == "anthropic":
                ...
                if tool_info:
                    ...
                    # Execute the tool
                    tool_result = await execute_shopping_tool(tool_name, tool_args, tenant_id, phone)

                    # Generate response based on tool result
                    response_text = format_shopping_response(tool_name, tool_args, tool_result)
